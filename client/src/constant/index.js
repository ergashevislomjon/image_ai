export const surpriseMePrompts = [
  ...
  "A Burst of Colors: Exploring the Vibrant Landscapes of the World",
  "Finding Serenity in Nature: A Photographic Journey",
  "The Beauty of the Natural World: Captured Through the Lens",
  "Serene Seascapes: The Power and Peace of the Ocean",
  "The Great Outdoors: A Photographic Exploration of Landscapes",
  "The Magic Hour: Capturing the Beauty of Sunsets",
  "A New Beginning: The Inspiring Beauty of Sunrises",
  "Majestic Mountains: The Grandeur of Nature",
  "A Rainbow of Colors: The Beauty of the Natural World",
  "Finding Inner Peace: The Serenity of Nature in Photographs",
];
